...
# from .processing_eagle2_5_vl import Eagle2_5_VLProcessor
...
class GR00TTransform(InvertibleModalityTransform):
    ...
    # MODIFIED for Python 3.8: Replaced `list[str]` with `List[str]`
    ...
    # MODIFIED for Python 3.8: Replaced `dict[str, int]` with `Dict[str, int]`
    ...
    max_length: int = 512
    # MODIFIED for Python 3.8: Replaced `EmbodimentTag | None` with `Optional[EmbodimentTag]`
