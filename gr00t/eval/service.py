...
# Importado 'Optional' para compatibilidade com Python 3.8
...
class MsgSerializer:
    @staticmethod
    # Alterado 'dict' para 'Dict' para compatibilidade com Python 3.8
...
class BaseInferenceClient:
    ...
    def call_endpoint(
        self,
        endpoint: str,
        # Alterado 'dict | None' para 'Optional[Dict[str, Any]]' para compatibilidade com Python 3.8
