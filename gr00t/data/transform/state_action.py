...
import functools
import random
# MODIFIED: Consolidated all typing imports
from typing import Any, ClassVar, Dict, Optional, Tuple, List, Union
...
class StateActionTransform(InvertibleModalityTransform):
    ...
    # MODIFIED: dict[str, str] -> Dict[str, str]
