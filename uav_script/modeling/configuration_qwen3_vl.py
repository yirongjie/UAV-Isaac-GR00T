...
# <--- MODIFIED: 导入 List, Dict, Union, Any, Optional 以兼容 Python 3.8
from typing import Optional, Union, List, Dict, Any

from transformers.configuration_utils import PretrainedConfig
# <--- MODIFIED: 移除了 v4.38.2+ 的 RoPE 工具
...
class Qwen3VLTextConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # 1. 存储 rope_theta (保留 Qwen3VL 自己的默认值)
        self.rope_theta = kwargs.get("rope_theta", 5000000.0)
